...
projects[humanitarianresponse_documents][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_documents.git"
...
projects[humanitarianresponse_clusters][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_clusters.git"
...
projects[humanitarianresponse_locations][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_locations.git"
...
projects[humanitarianresponse_emergencies][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_emergencies.git"
...
projects[humanitarianresponse_themes][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_themes.git"
...
projects[humanitarianresponse_organizations][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_organizations.git"
...
projects[humanitarianresponse_events][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_events.git"
...
projects[humanitarianresponse_links][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_links.git"
...
projects[humanitarianresponse_news][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_news.git"
...
projects[humanitarianresponse_maps][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_maps.git"
...
projects[humanitarianresponse_users][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_users.git"
...
projects[humanitarianresponse_layout][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_layout.git"
...
projects[humanitarianresponse_coordination][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_coordination.git"
...
projects[humanitarianresponse_funding][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_funding.git"
...
projects[humanitarianresponse_highlight][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_highlight.git"
...
projects[humanitarianresponse_display][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_display.git"
...
projects[humanitarianresponse_contacts][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_contacts.git"
...
projects[humanitarianresponse_search][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_search.git"
...
projects[humanitarianresponse_media][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_media.git"
...
projects[humanitarianresponse_resources][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_resources.git"
...
projects[humanitarianresponse_assessments][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_assessments.git"
projects[humanitarianresponse_assessments][download][branch] = "master"

projects[humanitarianresponse_indicators][type] = "module"
projects[humanitarianresponse_indicators][download][type] = "git"
projects[humanitarianresponse_indicators][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_indicators.git"
...
projects[humanitarianresponse_profiles][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_profiles.git"
...
projects[humanitarianresponse_core][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_core.git"
...
projects[humanitarianresponse_i18n][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_i18n.git"
...
projects[humanitarianresponse_mapping][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_mapping.git"
...
projects[humanitarianresponse_page][download][url] = "http://git.humanitarianresponse.info/git/humanitarianresponse_page.git"
...
libraries[humanitarianresponse][download][url] = "http://git.humanitarianresponse.info/git/profiler.git"
